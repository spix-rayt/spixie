...
class ChromaTransformer: ParticleArrayTransformer(1.0, 0.01, 0.0, 1.0) {
        ...
        when(parameterMode.value!!){
            ...
            Mode.Linear -> {
                ...
                particles.array.forEachIndexed { index, particle ->
                    ...
                    particle.chroma = linearInterpolate(first, last, t).toFloat()
                }
            }
            Mode.Random -> {
                ...
                particles.array.forEachIndexed { index, particle ->
                    ...
                    particle.chroma = (finalRand*(max - min)+min).toFloat()
                }
            }
        }
        return particles
