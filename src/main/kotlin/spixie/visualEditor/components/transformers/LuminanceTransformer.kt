...
class LuminanceTransformer: ParticleArrayTransformer(1.0, 0.002, 0.0, Double.POSITIVE_INFINITY) {
        ...
        when(parameterMode.value!!){
            ...
            Mode.Linear -> {
                ...
                particles.array.forEachIndexed { index, particle ->
                    ...
                    particle.luminance = linearInterpolate(first, last, t).toFloat()
                }
            }
            Mode.Random -> {
                ...
                particles.array.forEachIndexed { index, particle ->
                    ...
                    particle.luminance = (finalRand*(max - min)+min).toFloat()
                }
            }
        }
        return particles
