...
class TransparencyTransformer: ParticleArrayTransformer(1.0, 0.001, 0.0, 1.0) {
        ...
        when(parameterMode.value!!){
            ...
            Mode.Linear -> {
                ...
                particles.array.forEachIndexed { index, particle ->
                    ...
                    particle.transparency = linearInterpolate(first, last, t).toFloat()
                }
            }
            Mode.Random -> {
                ...
                particles.array.forEachIndexed { index, particle ->
                    ...
                    particle.transparency = (finalRand*(max - min)+min).toFloat()
                }
            }
        }
        return particles
